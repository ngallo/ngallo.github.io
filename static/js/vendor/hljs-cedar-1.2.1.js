...
Vendored verbatim from the official definition, npm highlightjs-cedar@1.2.1
(https://github.com/cedar-policy/highlightjs-cedar), src/cedar.js.

Only change: `module.exports =` → `export default`. The published package ships
CommonJS only and has no dist/ build, so it cannot be loaded from a CDN either
as a classic <script> or as an ESM import. Keep this note when bumping the
version, and re-apply the same one-line change.
*/
